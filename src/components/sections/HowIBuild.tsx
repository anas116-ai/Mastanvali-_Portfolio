...
export function HowIBuild() {
  return (
    <section id="how-i-build" className="section-padding relative">
      <div className="container-portfolio">
        <SectionHeader
          number="04"
          title="THE BUILDER METHODOLOGY: HOW I BUILD"
          subtitle="Honest, AI-assisted development. AI is the velocity accelerator; human engineering provides the architecture and debugging."
        />
        ...
        >
          ...
          >
            ...
            <p className="text-base md:text-xl text-slate-200 font-light leading-relaxed">
              I don&apos;t generate fake code or pretend AI autonomously creates working products. I use LLMs as <strong className="text-white font-bold">collaborative problem-solvers and high-speed scaffolding tools</strong>. The system boundaries, data contracts, edge-case resolution, and production debugging remain strictly under my human engineering control.
            </p>
          </motion.div>
