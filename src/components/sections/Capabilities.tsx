...
import { Database, ShieldCheck, Cpu, Code2, Terminal, CheckCircle2 } from "lucide-react";
    ...
    <section id="capabilities" className="section-padding relative">
      <div className="container-portfolio">
        <SectionHeader
          ...
          subtitle="Real, verified competencies grouped into enterprise data, operational support, and AI product engineering."
        />
