...
import { primaryProjects, Project } from "@/data/projects";
import {
  ExternalLink,
  ChevronDown,
  Layers,
  ...
  return (
    <section id="work" className="section-padding relative">
      <div className="container-portfolio">
        <SectionHeader
          number="01"
          title="FLAGSHIP SOFTWARE & CASE STUDIES"
          subtitle="Production-grade desktop systems, multi-agent frameworks, and AI platforms with verified repository proof."
        />
            ...
            return (
              <motion.div
                ...
                className={`rounded-2xl transition-all duration-300 border overflow-hidden ${
                  isExpanded
                    ? "glass-panel-glow border-[var(--color-accent)]/50 shadow-[0_15px_50px_rgba(0,240,255,0.1)]"
