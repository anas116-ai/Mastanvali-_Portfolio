...
// Dynamic 3D Human Avatar Scene (MoncyDev inspired)
const MoncyVibeAvatarScene = dynamic(
  () => import("@/components/scene/MoncyVibeAvatarScene").then((m) => m.MoncyVibeAvatarScene),
  { ssr: false }
);

export function VibeCoderHero() {
  ...
  return (
    <section className="relative min-h-[100svh] flex flex-col justify-center items-center overflow-hidden pt-28 pb-20">
      {/* 3D Human Character Vibe Coder Battle-Station */}
      <MoncyVibeAvatarScene />
      ...
      <div className="absolute top-24 right-6 sm:right-12 z-20 flex items-center gap-2 p-1.5 rounded-full bg-black/60 border border-white/10 backdrop-blur-xl">
        <div className="flex items-center gap-1.5 px-3 py-1 text-xs font-mono text-blue-400">
          ...
          <span className="hidden sm:inline">3D AVATAR ACTIVE</span>
        </div>
        ...
        >
          ...
          >
            ...
            <span className="font-mono text-xs font-semibold text-slate-200">
              STUDIO: ACTIVE &bull; HUMAN VIBE CODER
            </span>
          </motion.div>
          ...
          >
            I turn ideas into working applications at <span className="text-white font-semibold">10x speed with AI tools</span>, while applying <span className="text-white font-semibold">enterprise-grade architectural discipline</span>, rigorous data modeling, and deep debugging.
          </motion.p>
